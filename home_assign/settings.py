"""
Django settings for home_assign project.
...
WSGI_APPLICATION = 'home_assign.wsgi.application'
W
...
AWS_S3_CUSTOM_DOMAIN = 'd13c98tzvask0m.cloudfront.net'
